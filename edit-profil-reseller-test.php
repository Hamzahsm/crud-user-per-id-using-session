...
<head>
  ...
  <title>Edit Profil Reseller OESMAN</title>
...
<div class="row">
  <div class="col-lg col-md-6 col-sm-6 mb-4" data-aos="flip-left" data-aos-duration="500" data-aos-easing="ease-in-out">
    ...
    <div class="stats-small stats-small--1 card card-small" name="editbio">
      <!-- data satu -->
        <a class="card-body p-0 d-flex" href="edit-bio-reseller-test.php?id=<?php $row['id'] ;?>" data-toggle="" data-target="">
          <div class="d-flex flex-column m-auto">
            <div class="stats-small__data text-center">
              <i class="fas fa-user" style="font-size:48px; color: #570000;"></i>
              <span class="stats-small__label text-uppercase">EDIT BIO</span>
            </div>
          </div>
        </a>
      </div> 
    ...
    <div class="stats-small stats-small--1 card card-small">
      <!-- data dua -->
        <a class="card-body p-0 d-flex" href="upload-ktp-reseller.php" data-toggle="" data-target="">
          <div class="d-flex flex-column m-auto">
            <div class="stats-small__data text-center">
            <i class="fas fa-address-card" style="font-size:48px; color: #570000;"></i>
              <span class="stats-small__label text-uppercase">UPLOAD KTP</span>
            </div>
          </div>
        </a>
      </div>
    ...
    <div class="stats-small stats-small--1 card card-small">
        <!-- data tiga -->
      <a class="card-body p-0 d-flex" href="forgot-password-reseller.php" >
        <div class="d-flex flex-column m-auto">
          <div class="stats-small__data text-center">
          <i class="fas fa-key" style="font-size:48px; color: #570000;"></i>
            <span class="stats-small__label text-uppercase">UBAH PASSWORD</span>
          </div>
        </div>
      </a>
    </div>
...
<div class="col text-right view-report">
  <h5><a href="dashboard-reseller.php"> <i class="fas fa-sign-out-alt" style="font-weight: 48px;"></i> Kembali </a></h5>
</div>
